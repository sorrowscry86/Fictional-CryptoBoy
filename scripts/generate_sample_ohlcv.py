...
def generate_sample_ohlcv(
    symbol: str, start_date: datetime, end_date: datetime, timeframe_hours: int = 1, initial_price: float = None
) -> pd.DataFrame:
    """
    ...
    if initial_price is None:
        price_map = {"BTC/USDT": 67000, "ETH/USDT": 2600, "SOL/USDT": 160}
...
def main():
    ...
    for pair in pairs:
        ...
        df = generate_sample_ohlcv(symbol=pair, start_date=start_date, end_date=end_date, timeframe_hours=1)
